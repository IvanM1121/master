...
/*var logo=jQuery('.logo').clone();
jQuery(logo).find('a').css({'max-width':'unset'});
jQuery(logo).addClass('float-left header-logo ml-3 d-none');
jQuery(logo).insertBefore('.nav-btn');
jQuery('.nav-btn').on('click',function(){
	jQuery('.header-logo').toggleClass('d-none');
});*/
