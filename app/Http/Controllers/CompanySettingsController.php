...
class CompanySettingsController extends Controller
{
	...
	public function crm_settings(Request $request)
    {
		...
		$data['task_statuss'] = \App\TaskStatus::where('company_id',$company_id)
    	                                       ->orderBy("order","asc")
											   ->get();
		#$data['leadsources']->pluck('id')									   
		#$data['leadsource_users'] = \App\lead_source_users::get();
		$data['leadsource_users'] = \App\lead_source_users::with(['user','leadsource'])->get();
		//die(print_r($data['leadsource_users']));
